...
const modalTypeMap = {
  "dung pat": {
    ...
    back: ["//images/soil-101/biology/Shamwari-wildlife-13_9cXnSN_1S.jpg"],
  },
  animals: {
    front: <AnimalsSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/cows_Emma_Lee_ZfcoVj_7S.jpg",
      "//images/soil-101/biology/Lamb_FoodorFiber_0HM4NNT9a9.jpg",
      "//images/soil-101/biology/chickensWillMerydith_nIucM0ZQdvt.jpg",
    ],
  },
  archaea: {
    front: <ArchaeaSvg className="h-full w-full" />,
    back: ["//images/soil-101/biology/archaeen_ivLj_Rg_39f.jpg"],
  },
  bacteria: {
    front: <BacteriaSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/bacteria-gallery-1_Ar1EggtMgYx_qOpHDyZQF.jpg",
    ],
  },
  earthworm: {
    front: <EarthwormSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/mole_earthworm_a060_BSccWF.jpg",
      "//images/soil-101/biology/earthworms_AH_photoessay_8jugkC26M.png",
    ],
  },
  fungi: {
    front: <FungiSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/fungi_group_BaA_4yRqT.png",
      "//images/soil-101/biology/Mycorrhizal_root_tips__28amanita_29allversity_5q8wCdfVA_dbE0KKeDH.jpeg",
      "//images/soil-101/biology/Fungus_Decomposing_Leaf_Veins_fd_eKdaTMF.jpg",
    ],
  },
  arthropods: {
    front: <ArthopodsSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/Symphypleona-2_-WwT6YPz2.jpeg",
      "//images/soil-101/biology/Trachelipus_rathkii1_KIgF3rbTqY.jpeg",
    ],
  },
  nematode: {
    front: <NematodeSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/Nematodes_8251087088_58328868cb_o__1___1__riApNiIf8.jpg",
    ],
  },
  plants: {
    front: <PlantsSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/roots_JKx0MF4sA.png",
      "//images/soil-101/biology/Variety_of_Roots_Illustrated_DHIPM2la9yw.png",
    ],
  },
  protozoa: {
    front: <ProtozoaSvg className="h-full w-full" />,
    back: [
      "//images/soil-101/biology/protozoa-d5577a32-47e4-405d-845e-c9660b386ab-resize-750_zPOiEKibm.jpeg",
      "//images/soil-101/biology/amoeba_proteus_6_WGlVlCEqR.jpg",
    ],
  },
};
  ...
  return (
    <>
      <div ref={sectionRef} className={styles["section"]}>
        ...
        >
          soil is home to 1/4 of the world's biodiversity with billions of
          organisms -- 10's of 1,000's of species -- in a single teaspoon. the
          soil food web serves as the foundation of every (terrestrial) food web
          on the planet!
        </Text>
        <FoodWebSvg />
      </div>
