...
import { SoilDiversityModal } from "ui/components/soil-diversity-modal";
...
const data = {
  entisols: {
    textEmphasis: "baby",
    imageUrl:
      "/images/soil-101/diversity/Entisol_surface_Killburn_WLB_9vMq_fMa1.jpg",
    modalTitle: "little to no soil development",
    label: "young and/or low weathering environment",
    features: ["shallow", "high rock content"],
    modalImage:
      "/images/soil-101/diversity/Entisol_profile_Killburn_WLB_N-7Dq2xnJ5F.jpg",
  },
  inceptisols: {
    textEmphasis: "adolescent",
    imageUrl:
      "/images/soil-101/diversity/Inceptisol_surface_Dellwood_WLB_PuYJjmE3V.jpg",
    ...
    modalImage:
      "/images/soil-101/diversity/Inceptisol_profile_Dellwood_WLB_trHwpLtL_Ls.jpg",
  },
  aridisol: {
    textEmphasis: "dry",
    imageUrl: "/images/soil-101/diversity/Aridisol_surface_WLB_aUUD2iCB-.jpg",
    ...
    modalImage:
      "/images/soil-101/diversity/Aridisol_profile_WLB_VdQDq8dLhw7.jpg",
  },
  andisol: {
    textEmphasis: "volcanic",
    imageUrl: "/images/soil-101/diversity/Andisol_surface_WLB_bt0DvMLBvz3.jpg",
    modalTitle:
    ...
    modalImage: "/images/soil-101/diversity/Andisol_profile_WLB_EqR0ctPfe.jpg",
  },
  mollisol: {
    textEmphasis: "prairie",
    imageUrl: "/images/soil-101/diversity/Mollisol_surface_WLB_wxigXiVFyIr.jpg",
    modalTitle:
    ...
    modalImage: "/images/soil-101/diversity/Mollisol_profile_WLB_pwTI1PQ1T.jpg",
  },
  vertisol: {
    textEmphasis: "shrink-well",
    imageUrl: "/images/soil-101/diversity/vertisol_surface_jpCZk-4pEB.png",
    modalTitle:
    ...
    modalImage:
      "/images/soil-101/diversity/Vertisols_profile_WLB_b4bmPTzpUyf.jpg",
  },
  gelisol: {
    textEmphasis: "frozen",
    imageUrl: "/images/soil-101/diversity/Gelisol_surface_WLB_fLygyuAj0zq.jpg",
    modalTitle:
    ...
    modalImage: "/images/soil-101/diversity/Gelisol_profile_WLB_G8sfsfI05.jpg",
  },
  histosol: {
    textEmphasis: "wetland",
    imageUrl: "/images/soil-101/diversity/histosol_surface_KtsPucsZx.png",
    modalTitle:
    ...
    modalImage: "/images/soil-101/diversity/histosol_profile.jpg",
  },
  alfisol: {
    textEmphasis: "forest",
    imageUrl:
      "/images/soil-101/diversity/Alfisol_surface_WLB_San_Joaquin__ehAJ_aic.jpg",
    modalTitle:
    ...
    modalImage:
      "/images/soil-101/diversity/Alfisol_profile_WLB_San_Joaquin_az_MyVd9I.jpg",
  },
  spodosol: {
    textEmphasis: "boreal",
    imageUrl: "/images/soil-101/diversity/Spodosols_surface.jpg",
    modalTitle:
    ...
    modalImage: "/images/soil-101/diversity/Spodosol_profile_WLB_ud2qgMPxV.jpg",
  },
  ultisol: {
    textEmphasis: "old",
    imageUrl:
      "/images/soil-101/diversity/Ultisol_surface_Coxville_WLB_1__VENETQPvM.jpg",
    modalTitle:
    ...
    modalImage:
      "/images/soil-101/diversity/Ultisol_profile_Coxville_WLB_xGAQlyCTd.jpg",
  },
  oxisol: {
    textEmphasis: "tropical",
    imageUrl: "/images/soil-101/diversity/oxisol_surface_25_5R2WeW.jpg",
    modalTitle:
    ...
    modalImage:
      "/images/soil-101/diversity/oxisol_Profile2_WLB_ikuceYHR1kh.png",
  },
  anthrosol: {
    textEmphasis: "human",
    imageUrl: "/images/soil-101/diversity/anthrosol_surface_NKdtUYTsVh.jpg",
    modalTitle: "",
    label: "",
    features: [],
    modalImage: "",
