...
export const MeasuringSection = (props: {
    ...
    <>
      ...
      >
        ...
        <Text type="p" weight="light" size="sm" className={styles["p-50"]}>
          soil testing helps land managers evaluate the health of their systems.
          traditional lab tests focus on soil chemical properties, while soil
          health tests include physical and biological properties, as well.
        </Text>
        <MeasuringSvg />
      </div>
      {modalType && (
