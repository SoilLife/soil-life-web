...
export const WhatIsSection = (props: {
  ...
  useEffect(() => {
    ...
    function hidePopup(e: MouseEvent) {
      const physicalBiologicalChemicalSvg =
        sectionContainer.querySelector("#tri-bubble");
    ...
    <>
      ...
      >
        ...
        >
          ...
          and are directly influenced by management (i.e structure, organic
          matter).
        </Text>
        <div className="flex flex-col-reverse items-center justify-center gap-10 sm:flex-row sm:space-x-4 sm:space-y-4">
          <Text
            ...
            size="md"
            weight="light"
            className={`text-center max-w-[311px] ${styles["p-60"]}`}
          >
        ...
        >
          ...
          , healthy soil performs important{" "}
          <Text type="span" weight="bold" size="md" color="blue">
            functions
          </Text>{" "}
        ...
        <div className="grid grid-cols-2 grid-rows-4 gap-4 place-items-center xl:flex xl:items-center xl:gap-0 xl:space-x-8">
          ...
          >
            ...
            have the power to modify our DNA and promote overall health, the way
            we manage soil has a major impact on soil health!
          </Text>
        ...
        >
          ...
          . while many conservation practices improve soil structure, the
          ability to build and store SOM may be limited in some soils or
          climates.
        </Text>
        <CarbonSequestSvg />
        ...
        >
          ...
          . this requires a healthy living environment (good structure!) that
          optimizes their health and overall efficiency.
        </Text>
      </div>
      {modalType && (
        <FullImage
...
function Popup({
  ...
  return (
    <div
      className={`p-4 text-center space-y-4 w-fit sm:bg-white sm:shadow  ${className}`}
    >
