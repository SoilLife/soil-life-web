...
const modalTypeMap = {
  desertification: {
    imageUrl: "/images/soil-101/health/Soils_at_Risk_xa3jFk-qG.jpg",
  ...
  erosion: {
    imageUrl: "/images/soil-101/health/natgeo8_LM18ks0gTcb.jpg",
  ...
  "loss of structure": {
    imageUrl: "/images/soil-101/health/natgeo7_FWW0JHPzP.jpg",
  ...
  salinization: {
    imageUrl: "/images/soil-101/health/natgeo2_q1lRr9XA1.jpg",
  ...
  acidification: {
    imageUrl:
      "/images/soil-101/health/acid_sulfate_Southern_Cross_University_xfxO7chz6.png",
  ...
  urbanization: {
    imageUrl:
      "/images/soil-101/health/Greening-empty-lots-helps-reduce-depression-for-city-residents_hYgARqy5e.jpeg",
...
export const RisksSection = (props: {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      modalRef.current
        .querySelector(`#${modalType.replaceAll(" ", "-")}`)
  ...
  return (
    <>
      <div ref={props.assignRef} className={styles["section"]}>
        ...
        >
          a soccer field of soil is eroded every 5 seconds, an area the size of
          new york is sealed up every day, and 33% of the world's soils are
          considered moderately to highly degraded. this poses an existential
          threat -- to our food supply and the global economy. by working
          together to improve soil health, we can provide solutions to these
          global challenges.
        </Text>
      ...
      {modalType && (
        ...
        >
          ...
          <div ref={modalRef} className="flex gap-20 pb-4 overflow-x-auto">
            {Object.entries(modalTypeMap).map(
              ([modalTitle, { text, imageUrl }]) => {
                return (
                  <div
                    key={modalTitle}
                  ...
                  >
                    ...
                    <Image
                      ...
                      src={imageUrl}
                      alt=""
                      className="object-contain mx-auto max-w-[50vh]"
                    />
                    <Text
                      type="p"
                      weight="light"
                      size="sm"
                      className={`text-center ${styles["p-38"]}`}
                    >
                      {text}
                    </Text>
                  </div>
