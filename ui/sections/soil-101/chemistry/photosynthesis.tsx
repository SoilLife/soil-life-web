  ...
  return (
    <>
      <div ref={sectionRef} className={styles["section"]}>
        ...
        >
          as plant shoots grow aboveground, they act like solar panels, using
          energy from the sun to convert CO<sub>2</sub> from the atmosphere into
          the building blocks of life (i.e. carbohydrates, proteins, fats,
          nucleic acids).
        </Text>
      </div>
      {isModalOpen && (
