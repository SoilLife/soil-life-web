...
export const MetabolismSection = (props: {
  ...
  return (
    <>
      ...
      >
        ...
        >
          meanwhile, up to 60% of the plant's carbon is being pumped underground
          in the form of organic compounds (i.e. sugars, amino acids); providing
          food/fuel for soil microbes.
        </Text>
      </div>
      {isModalOpen && (
        <FullImage
