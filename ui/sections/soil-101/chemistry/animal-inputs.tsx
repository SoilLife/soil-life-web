...
export const AnimalInputsSection = (props: {
  ...
  return (
    <>
      ...
      >
        ...
        >
          above ground, animals nibble on plants. in response, plants change
          their root growth patterns and pump more carbon underground, in search
          of nutrients for regrowth. this herbivory has been shown to increase
        ...
        <Text
          ...
          className={`text-center ${styles["p-48"]}`}
        >
          urine and feces that grazers leave behind provides nutrient-rich food
          for microbes, enhancing nutrient cycling/availability. applications of
          these inputs have been found to increase soil organic matter.
        </Text>
        ...
        <Text
          ...
          className={`text-center ${styles["p-48"]}`}
        >
          trampling from animal hooves helps break up the soil and vegetation.
          this increases water infiltration, promoting decomposition and seed
          germination, allowing the cycle to begin again!
        </Text>
      </div>
      {isModalOpen && (
        <FullImage
