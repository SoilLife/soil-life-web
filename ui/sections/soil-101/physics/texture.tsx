...
const modalTypeMap = {
  sand: {
    title: "sand",
    imageUrl: "/images/soil-101/physics/sand.jpg",
  ...
  silt: {
    title: "silt",
    imageUrl: "/images/soil-101/physics/silt.jpg",
  ...
  clay: {
    title: "clay",
    imageUrl: "/images/soil-101/physics/clay.jpg",
...
export const TextureSection = (props: {
      ...
      >
        ...
        <div className="flex flex-col items-center gap-8 sm:flex-row-reverse">
          ...
          <Text
            ...
            weight="light"
            size="lg"
            className={`max-w-lg sm:w-1/2 ${styles["p-48"]}`}
          >
            ...
            of the soil - how it feels in your hand, how water moves through it,
            how fertile it is, and much more!
          </Text>
        </div>
      </div>
      {modalType && (
