    ...
    <>
      ...
      >
        ...
        <Text type="p" weight="thin" size="md" className={styles["p-60"]}>
          the way that individual soil particles (mineral and/or organic) stack
          together determines the size and shape of soil aggregates and the
          space between them; or what is known as soil structure. this is a more
          dynamic property that can change over short time periods.
        </Text>
