...
import { GenericModal } from "ui/components/soil-101-modals/generic-modal";
    ...
    description: (
      <>
        <Text type="p" weight="thin" size="xs">
          clay minerals are composed of <b>silica tetrahedra</b> and{" "}
          <b>aluminum octahedra</b> layered in sheets (1:1, 2:1, etc.). when
          these minerals form, silica (4<sup>+</sup>) is often substituted for
          aluminum (3<sup>+</sup>) or aluminum (3<sup>+</sup>) is substituted
          for magnesium (2<sup>+</sup>) or iron (2<sup>+</sup>). this creates a
          charge imbalance, which leaves the mineral with a permanent negative
          charge.
        </Text>
      </>
    ),
...
export const SurfaceChargeSection = (props: {
    ...
    <>
      <div ref={props.assignRef} className={styles["section"]}>
        ...
        <Text type="p" weight="thin" size="md" className="text-center">
          clays are considered the “active” portion of soil. they have higher
          total surface area and are often electrically charged (like magnets),
          allowing physical and chemical reactions to occur on their surfaces.
        </Text>
        ...
        <Text type="p" weight="thin" size="md" className="text-center">
          the large, charged surface of clays can hold onto water and nutrients;
          preventing their loss to gravity (or leaching). the amount and type of
          clays in a given soil largely determines its water and nutrient
          holding (or cation exchange) capacity.
        </Text>
        <div className="flex flex-col space-between gap-10 sm:gap-20 sm:flex-row">
          <div className="flex-grow">
            <button
              onClick={openModal("water holding capacity")}
          ...
          <div className="flex-grow">
            <button
              onClick={openModal("cation exchange")}
              className="h-full w-full hover:opacity-50"
            >
