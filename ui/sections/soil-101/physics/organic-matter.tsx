  ...
  return (
    <>
      <div ref={sectionRef} className={styles["section"]}>
        ...
        >
          the supra-molecular aggregation of plant, animal, and
          microbially-based compounds. organic materials in soil are in various
          stages of decomposition (or break down). some is converted into stable
          organic matter and can stick around for 100's to 1000's of years.
        </Text>
