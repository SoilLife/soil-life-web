...
export const TexturalClassSection = () => {
  ...
  useEffect(() => {
    ...
    dotRef.current.style.left = `calc(${
      imgBoundingClientRect.width * x
    }px - 8px)`;
    dotRef.current.style.top = `calc(${
      imgBoundingClientRect.height * (1 - y)
    }px - 8px)`;
  }, [values]);
  ...
  return (
    <div className={styles["section"]}>
      ...
      <Text type="p" weight="thin" size="md" className="ml-8">
        soils are grouped into 12 different textural classes that behave
        similarly, based on similar ranges of sand, silt, and clay.
      </Text>
      <Text type="p" weight="thin" size="xs" className="ml-8">
        {" "}
        enter numbers in the boxes below (equal to 100) to see what the textural
        class is: <br />
      </Text>
      ...
      <div className="sm:grid sm:grid-cols-2">
        <div className="mb-10 sm:mb-0">
          <div ref={imageContainer} className="relative">
            ...
            />
            <img
              id="soil-textural-class-image"
              src="/images/soil-101/physics/soil_textural_class.png"
            />
          </div>
        </div>
