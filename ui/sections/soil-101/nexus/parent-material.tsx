...
const modalTypeMap = {
  colluvium: {
    title: "colluvium",
    imageUrl: "/images/soil-101/nexus/colluvium.jpg",
  ...
  alluvium: {
    title: "alluvium",
    imageUrl: "/images/soil-101/nexus/alluvium.jpg",
  ...
  aeolian: {
    title: "aeolian",
    imageUrl: "/images/soil-101/nexus/aeolian.jpg",
  ...
  "lacustrine/marine": {
    ...
    imageUrl: "/images/soil-101/nexus/lacustrine.jpg",
  ...
  volcanic: {
    title: "volcanic",
    imageUrl: "/images/soil-101/nexus/volcanic.jpg",
  ...
  glacial: {
    title: "glacial",
    imageUrl: "/images/soil-101/nexus/glacial.png",
  ...
  organic: {
    title: "organic",
    imageUrl: "/images/soil-101/nexus/organic_parent_material.jpg",
    ...
    <>
      <div ref={sectionRef} className={styles["section"]}>
        <Text
          ...
          size="2xl"
          color="pink"
          className={`w-full ${styles["heading"]}`}
        >
          parent material
        </Text>
