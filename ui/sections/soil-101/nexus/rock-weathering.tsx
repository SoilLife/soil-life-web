...
export const RockWeatheringSection = (props: {
      ...
      >
        <div className="grid gap-4 sm:grid-cols-4">
          ...
          <Text
            ...
            weight="light"
            size="md"
            className={`sm:col-span-3 ${styles["p-60"]}`}
          >
            through a combination of physical, biological, and chemical
            processes, rocks break down into smaller and smaller pieces.
          </Text>
        </div>
...
function Popup({
  ...
  return (
    <div
      className={`py-8 px-12 absolute top-0 bg-white shadow-xl ${className}`}
    >
      <button onClick={onClick}>
        <Icon
          icon="x"
          size={24}
          className="absolute top-4 left-4 text-gray-500 opacity-50"
        />
      </button>
