...
const modalTypeMap = {
  time: {
    image: "/images/soil-101/nexus/time.jpg",
    text: 'Time amplifies all the other factors. "with water and time -- everything changes" - leonardo davinci',
  },
  "parent material": {
    image: "/images/soil-101/nexus/parent_material_nexus_7M0o24vSQAE.jpg",
  ...
  climate: {
    image: "/images/soil-101/nexus/air_climate.jpg",
  ...
  organisms: {
    image: "/images/soil-101/nexus/organisms.jpg",
  ...
  topography: {
    image: "/images/soil-101/nexus/topography.jpg",
  ...
  anthropogenic: {
    image: "/images/soil-101/nexus/anthropogenic.jpg",
...
export const FormationSection = (props: {
