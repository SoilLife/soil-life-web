...
export const EcosystemServicesSection = (props: {
  ...
  return (
    <>
      ...
      >
        ...
        >
          soils are the foundation of nearly every ecosystem on the planet,
          providing important services that give rise to healthy plants, healthy
        ...
        <div className="relative" style={{ height: "fit-content" }}>
          ...
          {modalType && (
            <ServicePopup {...modalTypeMap[modalType]} onClose={handleClose} />
          )}
        </div>
        <Text
          type="p"
...
function ServicePopup({
  ...
  return (
    <div
      className={`bg-white p-4 shadow-lg absolute cursor-pointer ${className}`}
      onClick={onClose}
    >
      <Text
        type="h1"
