...
const modalTypeMap = {
  additions: "/images/soil-101/nexus/additions_9NxZVypDg.png",
  losses: "/images/soil-101/nexus/losses_4xgqo0ix9.png",
  transformations: "/images/soil-101/nexus/transformations_KSFwxq0hS.png",
  translocations: "/images/soil-101/nexus/translocations_KoJ3eAVfB.png",
};

export const ProcessesSection = (props: {
  assignRef: (el: null | HTMLDivElement) => void;
}) => {
  const isMobile = useMedia("(max-width: 640px)", false);
  const [modalType, setModalType] = useState<
    null | "additions" | "losses" | "transformations" | "translocations"
  >(null);
  ...
  useEffect(() => {
    ...
    const additionsSvg = makeInteractive(
      sectionContainer.querySelector("#soil_processes_svg__Layer_83"),
      "additions"
    );
    const lossesSvg = makeInteractive(
      sectionContainer.querySelector("#soil_processes_svg__Layer_84"),
      "losses"
    );
