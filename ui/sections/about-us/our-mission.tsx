...
// assets
import bgImg from "public/images/about-us/About_Us_Our_mission_OIGaEwKm7.jpeg";
...
function NumberItem(props: React.PropsWithChildren<{ className?: string }>) {
  return (
    <h4
      className={`text-pink-500 font-acre-regular text-[24px] xl:text-[40px] 2xl:text-[50px] ${
        props.className ?? ""
      }`}
    >
      {props.children}
...
export function OurMissionSection() {
  return (
    <div className="h-screen relative snap-start lg:flex lg:flex-row-reverse">
      <div className="relative h-[50vh] overflow-hidden lg:h-auto">
        <Image
          src={bgImg}
          alt=""
          className="h-full scale-125 object-cover object-center lg:scale-100 xl:scale-125"
          placeholder="blur"
        />
      </div>
      <div
      ...
      >
        ...
        <div className="lg:space-y-6 xl:space-y-8">
          <div>
            ...
            <Paragraph>
              to inspire the next generation of soil explorers for the benefit
              of all
            </Paragraph>
          </div>
          ...
          <div>
            ...
            <Paragraph>
              to educate that soils are living bodies that harbor a diversity of
              life, and support and sustain life as we know it
            </Paragraph>
          </div>
          ...
          <div>
            ...
            <Paragraph className="w-[277px] mx-auto sm:w-auto">
              to empower young people with solutions to some of our greatest
              global challenges; solutions that lie right beneath our feet!
            </Paragraph>
          </div>
        </div>
      </div>
