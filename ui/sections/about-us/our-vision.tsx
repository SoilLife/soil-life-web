...
// assets
import bgImg from "public/images/about-us/Sunset_Yellow_Farm_Crops_Agriculture_iIMzdc_Nn8v.jpg";
...
export function OurVisionSection() {
  return (
    <div className="h-screen relative snap-start overflow-hidden">
      <div className="relative h-2/3 sm:h-1/2 lg:h-full">
        <Image src={bgImg} alt="" className="object-cover" placeholder="blur" />
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <Paragraph>
            a world in which people love and protect the soil upon which we all
            depend; a world where consumers value products grown in healthy
            soils; where agriculture regenerates, rather than degrades, the
            soil, and businesses find profitable ways to source products without
