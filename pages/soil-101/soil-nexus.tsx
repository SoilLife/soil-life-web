...
// components
import { SectionsNavBar, Footer } from "ui/templates";
...
import {
  ...
  ProcessesSection,
} from "ui/sections/soil-101/nexus";
...
export default function SoilNexusPage() {
  ...
  function handleDownArrowClick() {
    ...
    if (refs.current["soil nexus"]) {
      window.scrollTo({
        behavior: "smooth",
        top: refs.current["soil nexus"].offsetTop - headerOffsetTop,
      });
    }
  }
  ...
  return (
    <DefaultLayout title="Soil Nexus">
      <Soil101Header className="bg-pink-500" />
