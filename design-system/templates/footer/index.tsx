      ...
      <footer className='container h-full flex items-center h-max-[700px] pb-10 sm:pb-0'>
        <div className='flex flex-col items-center justify-between lg:flex-row'>
          ...
          <div className='w-full lg:w-1/3'>
            <Text type='p' weight='bold' size='sm' className='p-1 mb-6 text-white bg-pink-500'>
              stay connected.
            </Text>
            <SocialMediaIcons className='flex justify-center gap-4 mb-6 sm:justify-start' />
            <Text type='p' weight='regular' size='md' className='text-center text-teal-500 lg:text-right'>
              soil life is a PhD project based out of UC Davis in collaboration and with support from USDA-NRCS.
            </Text>
            <Text type='p' weight='bold' size='md' className='text-center text-teal-500 lg:text-right'>
