      ...
      <div className='h-full overflow-auto'>
        ...
        <div className='h-full w-full flex flex-col-reverse sm:grid sm:grid-cols-5'>
          <div className='flex flex-col items-center justify-between p-4 sm:col-span-3'>
            ...
            <div>
              <Text type='h3' weight='light' size='md' className='underline text-center'>
                features:
              </Text>
              <ul className='space-y-1'>
                {features.map((feature) => (
                  <li key={feature}>
                    <Text type='h3' weight='light' size='md' className='text-center'>
                      {feature}
                    </Text>
                  </li>
                ))}
          ...
          <Image url={imageKitUrl} className='object-cover sm:col-span-2' />
        </div>
      </div>
    </ReactModal>
  );
