...
const integrateAnimalsHeadings: (keyof typeof integrateAnimalsMap)[] = [
  "animals",
  "timing",
  "intensity",
];

export const PrinciplesSection = (props: {
  assignRef: (el: null | HTMLDivElement) => void;
}) => {
  const [activeHeading, setActiveHeading] =
    useState<keyof typeof integrateAnimalsMap>("animals");
  return (
    <div
      ref={props.assignRef}
      className={`text-center ${styles["principles-section"]}`}
    >
      <Text
        id="principles"
        type="h1"
      ...
      <div className="space-y-8">
        ...
        <Text type="p" weight="light" size="lg" className={styles["p-60"]}>
          about half of the soil's volume should consist of open pore space,
          allowing{" "}
      ...
      <div className="space-y-8">
        ...
        <Text type="p" weight="light" size="lg" className={styles["p-60"]}>
          for every 1% increase in soil organic matter, a soil can hold upto 1
          extra inch -- or 20,000 extra gallons -- of water/acre.
        </Text>
      ...
      <div className="space-y-8">
        ...
        <Text type="p" weight="light" size="lg" className={styles["p-60"]}>
          seeding with a "cocktail mix" of 6-12 different plants provides
          diversity above-ground, which breeds much needed diversity
          below-ground. including legumes in your cocktail allows microbes to
          pull nitrogen out of the atmosphere and into the soil -- free
          fertilizer for your cash crop.
        </Text>
      ...
      <div className="space-y-8">
        ...
        <div className="mx-auto relative max-w-[65vw]">
          <button
