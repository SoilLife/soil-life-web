  ...
  return (
    <div className={styles['section']}>
      ...
      <Text type='p' weight='thin' size='lg' className='ml-8'>
        soil texture can be grouped into 12 different classes that behave similarly; each with its own range in percentage sand, silt, and clay. texture is a fixed (or inherent) property that doesn't change over human timescales.
      </Text>
