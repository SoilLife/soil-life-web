  ...
  return (
    <>
      <div ref={props.assignRef} className={styles["section"]}>
        <Text id="charge" type="h1" weight="light" size="4xl" color="yellow" className={styles["heading"]}>
          clay properties
        </Text>
        <Text type="p" weight="thin" size="md" className="text-center">
          clays are considered the “active” portion of soil. they have higher total surface area and are often
          electrically charged (like magnets), allowing physical and chemical reactions to occur on their surfaces.
        </Text>
        ...
        <Text type="p" weight="thin" size="md" className="text-center">
          the large, charged surface of clays can hold onto water and nutrients; preventing their loss to gravity (or
          leaching). the amount and type of clays in a given soil largely determines its water and nutrient holding (or
