...
export const AridisolSection = (props: { assignRef: (el: null | HTMLDivElement) => void }) => {
  return (
    <div ref={props.assignRef}>
      ...
      <div className='w-3/4 max-h-full mx-auto border-2 border-solid border-gray-500'>
        <Image url='Soil_101/Diversity_-_Soil_Profiles/Aridisol_surface_WLB_aUUD2iCB-.jpg' className='object-cover ' />
      </div>
    </div>
  );
};
