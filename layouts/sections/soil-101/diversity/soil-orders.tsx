...
const data = {
  entisols: {
    textEmphasis: 'baby',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Entisol_surface_Killburn_WLB_9vMq_fMa1.jpg',
    modalTitle: 'little to no soil development',
    label: 'young and/or low weathering environment',
    features: ['shallow', 'high rock content'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Entisol_profile_Killburn_WLB_N-7Dq2xnJ5F.jpg',
  },
  inceptisols: {
  ...
  aridisol: {
    textEmphasis: 'dry',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Aridisol_surface_WLB_aUUD2iCB-.jpg',
    ...
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Aridisol_profile_WLB_VdQDq8dLhw7.jpg',
  },
  andisol: {
    textEmphasis: 'volcanic',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Andisol_surface_WLB_bt0DvMLBvz3.jpg',
    modalTitle: 'developed from volcanic ejecta; rapid transformation of ash to poorly crystallized minerals.',
    label: 'contains volcanic material',
    features: ['highly fertile', '>5% soil organic matter', 'in surface 18-25cm'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Andisol_profile_WLB_EqR0ctPfe.jpg',
  },
  mollisol: {
    textEmphasis: 'prairie',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Mollisol_surface_WLB_wxigXiVFyIr.jpg',
    modalTitle: 'surface horizon contains significant amount of soil organic matter (>5% in top 18-25 cm)',
    label: 'found in grasslands',
    features: ['high organic matter', 'good/fast infiltration', 'granular structure'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Mollisol_profile_WLB_pwTI1PQ1T.jpg',
  },
  vertisol: {
    textEmphasis: 'shrink-well',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/vertisol_surface_jpCZk-4pEB.png',
    modalTitle: 'high in clays that swell when wet and shrink when dry, physically churning the soil',
    label: 'high in magnesium',
    features: ['very high clay', 'slickensides', 'wedge structure'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Vertisols_profile_WLB_b4bmPTzpUyf.jpg',
  },
  gelisol: {
    textEmphasis: 'frozen',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Gelisol_surface_WLB_fLygyuAj0zq.jpg',
    modalTitle: 'contains a layer of ice (permafrost) that stays frozen for at least 2 consecutive years',
    label: 'found in cold environments',
    features: ['high organic matter', 'frozen layer - permafrost'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Gelisol_profile_WLB_G8sfsfI05.jpg',
  },
  histosol: {
    textEmphasis: 'wetland',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/histosol_surface_KtsPucsZx.png',
    modalTitle: 'formed from organic parent material; minimum 12-18% organic in the top 40 cm',
  ...
  alfisol: {
    textEmphasis: 'forest',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Alfisol_surface_WLB_San_Joaquin__ehAJ_aic.jpg',
    modalTitle: 'subsurface accumulation of clay and high concentration of Na, K, Ca, and Mg',
    label: 'found in forests',
    features: ['high fertility', 'moderate to high clay'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Alfisol_profile_WLB_San_Joaquin_az_MyVd9I.jpg',
  },
  spodosol: {
    textEmphasis: 'boreal',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Spodosols_surface.jpg',
    modalTitle: 'has a zone of eluviation and a zone of accumulation of Fe + Al bound to organic matter',
    label: 'found in temperate forests',
    features: ['low pH', 'high clay', 'low infiltration rates', 'poor/slow drainage'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Spodosol_profile_WLB_ud2qgMPxV.jpg',
  },
  ultisol: {
    textEmphasis: 'old',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/Ultisol_surface_Coxville_WLB_1__VENETQPvM.jpg',
    modalTitle: 'highly weathered, clay accumulation at depth, low in Na, K, Ca, Mg',
    label: 'highly weathered',
    features: ['low fertility', 'moderate to high clay'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/Ultisol_profile_Coxville_WLB_xGAQlyCTd.jpg',
  },
  oxisol: {
    textEmphasis: 'tropical',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/oxisol_surface_25_5R2WeW.jpg',
    modalTitle: 'absence of important plant nutrients, predominance of iron and aluminum oxides',
    label: 'known as "red earth"',
    features: ['low pH', 'high clay', 'low infiltration rates', 'poor/slow drainage'],
    modalImage: 'Soil_101/Diversity_-_Soil_Profiles/oxisol_Profile2_WLB_ikuceYHR1kh.png',
  },
  anthrosol: {
    textEmphasis: 'human',
    imageUrl: 'Soil_101/Diversity_-_Soil_Profiles/anthrosol_surface_NKdtUYTsVh.jpg',
    modalTitle: '',
    label: '',
    features: [],
    modalImage: '',
...
export const SoilOrdersSection = (props: { assignRef: (el: null | HTMLDivElement) => void }) => {
  useFullpageOverflow();
