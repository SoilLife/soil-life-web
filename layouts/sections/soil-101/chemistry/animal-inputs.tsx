...
export const AnimalInputsSection = (props: { assignRef: (el: null | HTMLDivElement) => void }) => {
  ...
  useEffect(() => {
    ...
    const nutrientUptake = makeSvgInteractive({
      svg: sectionContainer.querySelector('#animal_inputs_2_svg__Layer_81'),
      onClick: openModal,
      onKeydown: openModal,
  ...
  return (
    <>
      ...
      >
        ...
        <AnimalInputs1Svg className='mx-auto max-w-[800px]' />
        ...
        <AnimalInputs3Svg className='mx-auto max-w-[800px]' />
        <Text type='p' weight='light' size='md' className={`text-center ${styles['p-48']}`}>
