  ...
  return (
    <div ref={ref}>
      ...
      <Text type='p' weight='light' size='md'>
        as shoots grow, they act like solar panels, with the sun fueling conversion of CO2 from the atmosphere into the
        building blocks of life (carbohydrates, proteins, fats, etc).
      </Text>
    </div>
  );
});
