...
export function OurVisionSection() {
  return (
    <Section>
      ...
      >
        <div
          className={`p-4 bg-white rounded-3xl shadow-lg text-center max-w-xs mx-auto transform -translate-y-8
        sm:translate-y-0 sm:max-w-lg sm:shadow-none sm:rounded-none
        xl:max-w-2xl xl:p-10
        2xl:max-w-5xl`}
        >
          <Text type='h1' weight='regular' size='xl' className='text-orange-500 mb-4 sm:mb-10'>
            our vision
          </Text>
