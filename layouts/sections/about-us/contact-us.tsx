          ...
          >
            ...
            <div className='space-y-2 xl:space-y-2'>
              <Text type='p' weight='thin' size='xs'>  
                e-mail:  </Text> <Text type='p' weight='thin' size='xs' color='blue' className='underline w-full'> <a href="mailto:jessica@soillife.org?subject=Soil Life Web Contact">jessica@soillife.org</a>          
              </Text>
