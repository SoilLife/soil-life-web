...
export function HeroSection() {
  return (
    <Section className='text-white'>
      ...
      <div className='absolute w-3/4 text-white transform translate-x-1/2 bottom-[15%] right-1/2 sm:w-1/2'>
        <Text type='h1' weight='medium' size='5xl' style={{ lineHeight: 1 }}>
          we all share
        </Text>
        <Text type='h1' weight='medium' size='5xl' style={{ lineHeight: 1 }}>
          common ground.
      ...
      <div className='absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center'>
        ...
        <Text type='p' weight='light' size='sm' className='mb-1'>
          connected
        </Text>
